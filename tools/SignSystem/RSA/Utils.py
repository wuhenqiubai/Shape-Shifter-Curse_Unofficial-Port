...
def loadSubKeySegment(subKeyType: int, rootPublicKey: typing.Optional[rsa.RSAPublicKey] = None) -> typing.Optional[ScriptTypes.SubKeySegment]:
...
def isDataSegmentValid(dataSegment: ScriptTypes.IDataSegment, keySegment: ScriptTypes.SubKeyPublicSegment, dataSignature: bytes) -> bool:
	...
	try:
		publicKey.verify(dataSignature, dataSegment.save(), padding.PKCS1v15(), hashes.SHA256())
		return True
	except:
		return False
