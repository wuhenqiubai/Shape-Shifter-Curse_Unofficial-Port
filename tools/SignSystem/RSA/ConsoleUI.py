...
def SubKeyUI(publicKey: typing.Optional[rsa.RSAPublicKey], privateKey: typing.Optional[rsa.RSAPrivateKey]):
	print("-- 创建子密钥 --")
...
def printAuthFileData(fileName: str, authFileBytes: bytes, publicKey: typing.Optional[rsa.RSAPublicKey] = None):
	try:
