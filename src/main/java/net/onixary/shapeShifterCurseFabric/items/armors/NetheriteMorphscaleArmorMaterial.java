...
public class NetheriteMorphscaleArmorMaterial {
    public static final ArmorMaterial INSTANCE = new ArmorMaterial(
        ...
        List.of(new ArmorMaterial.Layer(Identifier.fromNamespaceAndPath(ShapeShifterCurseFabric.MOD_ID, "netherite"))),
        2.0F,
        0.1F
    );

    public static final Holder<ArmorMaterial> ENTRY = Registry.registerForHolder(BuiltInRegistries.ARMOR_MATERIAL,
            Identifier.fromNamespaceAndPath(ShapeShifterCurseFabric.MOD_ID, "netherite_morphscale"), INSTANCE);
}