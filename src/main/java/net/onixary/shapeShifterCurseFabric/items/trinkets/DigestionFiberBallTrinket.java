...
public class DigestionFiberBallTrinket extends AccessoryItem {
    public DigestionFiberBallTrinket(Properties settings) {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> consumer, TooltipFlag type) {
        consumer.accept(Component.translatable("item.shape-shifter-curse.digestion_fiber_ball.tooltip").withStyle(ChatFormatting.YELLOW));
    }
}
