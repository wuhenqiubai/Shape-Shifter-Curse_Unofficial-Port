...
public class ToughAsNailsThirstHooksMixin {
    ...
    private static void shapeShifterCurseFabric$modifyThirstExhaustion(IThirst thirst, float exhaustion, Operation<Void> original, @Local(argsOnly = true) Player player) {
