...
public class ToughAsNailsDrinkInWorldPacketMixin {
    ...
    private static boolean shapeShifterCurseFabric$preventHandDrinkingThirstEffect(PlayerEntity player, StatusEffectInstance effect, Operation<Boolean> original) {
